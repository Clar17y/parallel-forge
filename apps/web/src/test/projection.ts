...
export function projection(overrides: Partial<components['schemas']['RunProjection']> = {}): components['schemas']['RunProjection'] {
  return {
    ...
    resource: { teardown_confirmation: 'teardown:run-1:identity', database_role: null, worktree_path: null, branch_name: null, database_state: 'DISABLED', database_name: null },
