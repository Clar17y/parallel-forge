...
class EvidenceSet(Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            ...
            "kind",
            "head_sha",
            name="uq_evidence_sets_head_parent",
        ),
        ...
        ForeignKeyConstraint(
            ...
            [
                ...
                "agent_executions.step_id",
                "agent_executions.role",
            ],
            ondelete="RESTRICT",
        ),
        ForeignKeyConstraint(
            [
                ...
                "run_id",
                "validation_parent_policy_version",
                "validation_parent_kind",
                "validation_parent_head_sha",
            ],
            [
                "evidence_sets.id",
                "evidence_sets.run_id",
                "evidence_sets.policy_version",
                "evidence_sets.kind",
                "evidence_sets.head_sha",
            ],
            ondelete="RESTRICT",
        ),
        ForeignKeyConstraint(
            [
                ...
                "run_id",
                "prior_review_parent_policy_version",
                "prior_review_parent_kind",
            ],
            [
                "evidence_sets.id",
                "evidence_sets.run_id",
        ...
        CheckConstraint(
            "(validation_evidence_set_id IS NULL OR id <> validation_evidence_set_id) AND (prior_review_evidence_set_id IS NULL OR id <> prior_review_evidence_set_id)",
    ...
    manifest_artifact_id: Mapped[UUID] = mapped_column(
...
class AgentExecutionEvidenceInput(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(
            ["consumer_execution_id", "run_id"],
            ["agent_executions.id", "agent_executions.run_id"],
            ondelete="RESTRICT",
        ),
        ForeignKeyConstraint(
            ["evidence_set_id", "run_id"],
            ["evidence_sets.id", "evidence_sets.run_id"],
            ondelete="RESTRICT",
        ),
        CheckConstraint(
            "(purpose = 'validation_results' AND evidence_kind = 'validation') OR (purpose = 'prior_review' AND evidence_kind = 'review')",
            name="purpose_kind",
        ),
